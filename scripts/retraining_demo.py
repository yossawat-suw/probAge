...
DSET_NAME = 'IFN' # external dataset name

# %%
meta_data = pd.read_csv('../data/sample_data_IFN_40.csv', index_col=0)
data = ad.read_csv('../data/Raw_Beta_Values_QCed_IFN_40.csv')
data.var = meta_data
